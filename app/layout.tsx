            ...
            <nav className="container mx-auto px-4 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    onClick={() => window.location.href = '/api/sounds/random'}
                    className="weird-button px-4 py-2 rounded-lg text-white font-semibold hover:scale-105 transition-transform"
                  >
                    🎲 Weird Roulette
                  </button>
                </div>
